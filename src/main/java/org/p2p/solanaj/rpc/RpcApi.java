...
public class RpcApi {
    ...
    @Deprecated
    public TransactionResult getConfirmedTransaction(String signature) throws RpcException {
        List<Object> params = new ArrayList<Object>();
        params.add(signature);

        return client.call("getConfirmedTransaction", params, TransactionResult.class);
    }
    ...
    public List<AddressSignatures> getSignaturesForAddress(String address) throws RpcException {
        return getSignaturesForAddress(address, Commitment.FINALIZED, 1000);
    }

    public List<AddressSignatures> getSignaturesForAddress(String address, Commitment commitment) throws RpcException {
        return getSignaturesForAddress(address, commitment, 1000);
    }

    public List<AddressSignatures> getSignaturesForAddress(String address, Commitment commitment, int limit) throws RpcException {
        Map<String, Object> limitObj = new HashMap<>();
        limitObj.put("limit", limit);
        limitObj.put("commitment", commitment.getValue());
        ...
        List<AddressSignatures> result = new ArrayList<>();
        for (AbstractMap item : rawResult) {
            result.add(new AddressSignatures(item));
        }
